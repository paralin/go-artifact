...
func (d *Artifact) MakeRequest(
	...
	d.le.Debugf("making request: %s", protocol.EGCDCGClientMessages(reqMsgID).String())
...
func (d *Artifact) handleResponsePacket(le *logrus.Entry, packet *gamecoordinator.GCPacket) (handled bool) {
	d.pendReqMtx.Lock()
